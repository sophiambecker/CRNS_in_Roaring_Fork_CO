...
outFold = '\\ModCountsProcessing_UTS_output_no_fs{}'.format(stamp)
...
def process_local(new_site_name) -> None:
    ...
    return(df2, Site, fscal)


# directory path for raw data

directory_path = 'C:\\Users\\sbecker14\\Documents\\GitHub\\CRNS_in_Roaring_Fork_CO\\Data\\Data_Relase_2024_b'
