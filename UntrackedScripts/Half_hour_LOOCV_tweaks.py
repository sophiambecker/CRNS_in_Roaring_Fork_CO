...
Dir = os.getcwd()
outFold = '\\Calibration_AnalysisWithKGE_output_tweaks{}'.format(stamp)
...
out_df_use = out_df.drop(out_df[out_df['NewName']=='C4'].index).copy().reset_index()
...
# identify outliers
#out_df_use = out_df.copy()#out_df.drop(out_df[out_df['NewName']=='C4'].index).copy()
...
out_df.to_csv(f'{outDir}\\Site_data_summary_withC4.csv')
