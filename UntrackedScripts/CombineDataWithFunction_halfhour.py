...
outDir = os.path.normpath(inDir + os.sep + 'CombineDataWithFunction_half_hr_output'+stamp) + '\\'   # Set output directory
...
directory_path_nc = 'Data\\ModCountsProcessing_Des_output20251212'
...
directory_path_nc = 'Data\\ModCountsProcessing_UTS_output20251212'
file_pattern_nc = f'{directory_path_nc}/Mod*'
file_paths = glob.glob(file_pattern_nc, recursive=True)
dataframes_loc_UTS_f3 = [pd.read_csv(file_path) for file_path in file_paths]

# USGS data release
directory_path_usgs = 'C:\\Users\\sbecker14\\Documents\\GitHub\\CRNS_in_Roaring_Fork_CO\\Data\\Data_Relase_2024_b'
